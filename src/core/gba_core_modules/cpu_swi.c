...
/* ===== Imported from reference implementation/bios.c ===== */
...
/* ===== Imported from reference implementation/hlebios.c ===== */
/* ===== Imported from reference implementation/hlebios.s moved to src/core/gba_core_modules/hlebios.s ===== */
