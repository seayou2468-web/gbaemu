...
# Update Write8 for VRAM/OAM/Palette to replicate byte to halfword
# Reference: "バイト書き込みを試行した場合、対象の8-bit値が16-bitの上位・下位両方に複製されて書き込まれる"
# Actually, the user says VRAM/OAM/Palette.
# Previously we ignored VRAM/OAM 8-bit. Now we replicate.
